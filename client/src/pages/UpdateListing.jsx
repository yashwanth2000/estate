...
export default function UpdateListing() {
  ...
  useEffect(() => {
    const fetchListing = async () => {
      ...
      const response = await fetch(`/listing/get/${listingId}`);
  ...
  return (
    <main className="p-6 max-w-5xl mx-auto">
      <h1 className="text-4xl font-bold text-center mb-10">Update Listing</h1>
      <form
      ...
      >
        ...
        <div>
          ...
          <div className="mt-8">
            ...
            >
              {loading || uploading ? "Loading..." : "Update Listing"}
            </button>
